...
def gcd(natural_number_a, natural_number_b):
    remainder = natural_number_a % natural_number_b
    if remainder == 0:
      return natural_number_b
    return gcd(natural_number_b, remainder)
...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    if player_score and opponent_score and gcd(player_score, opponent_score) >= 10:
      return True
    return False
    # END PROBLEM 4a
...
def my_turn(strategy, score, opponent_score, dice, goal):
    score += take_turn(strategy(score, opponent_score), opponent_score, dice)
    while score < goal and extra_turn(score, opponent_score):
      score += take_turn(strategy(score, opponent_score), opponent_score, dice)
    return score
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
      score, opponent_score, strategy = (score1, score0, strategy1) if who else (score0, score1, strategy0)
      score += take_turn(strategy(score, opponent_score), opponent_score, dice)
      # one turn, change one value
      if who:
        score1 = score
      else:
        score0 = score        
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def announce_higher(score0, score1):
